        ...
        <div class="project-bg">
          <div class="container">
            <div class="form-container">
              <form @submit.prevent="showModal">
                ...
                <VueSimpleAlert />
                <button type="submit">CREAR SUB COLOR</button>
              </form>
            </div>
          </div>
          ...
          <div v-if="isThankYouModalVisible" class="modal">
            <div class="modal-content">
              ...
              <p>Gracias por crear el Color, se ha registrado correctamente.</p>
    ...
    flecha(){
      ...
      async submitForm() {
        try {
          ...
          const response = await axios.post("https://localhost:7061/api/SubColor/Guardar", this.form);
          ...
          console.error(error);
          this.$alert('Ocurrió un error al guardar el Color.');
        } finally {
          this.hideModal();
        }
      },
      mostrarAlerta() {
        this.$alert('¡El Color ha sido creado!');
      }
    }
  };
  </script>
