    ...
    <div>
      <section id="usuario">
        ...
        <div class="project-bg">
            ...
            <div class="form-container">
              <form @submit.prevent="showModal">
                <div class="input-group">
                  <input type="text" id="nombreCompleto" name="nombreCompleto" placeholder="Nombre Del Perfil" required v-model="form.nombreRol" readonly>
          ...
          :options="rolOptions" 
          v-model="Relacione" 
          :reduce="item => item.idPermiso" readonly
>
        </v-select>
                </div>
                <VueSimpleAlert />
