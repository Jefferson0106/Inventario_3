              ...
              <form @submit.prevent="showModal">
                <div class="input-group">
                  <div class="input-with-icon">
                    ...
                    <input type="text" id="nombreAlmacen" name="nombreAlmacen" placeholder="Nombre del Almacén" required v-model="form.nombreAlmacen" disabled>
                  </div>
                  <div class="input-with-icon">
                    <i class="fa-solid fa-location-dot"></i>
                    <input type="text" id="ubicacion" name="ubicacion" placeholder="Ubicación" required v-model="form.ubicacion" disabled>
                  </div>
                  <div class="input-with-icon">
                    <i class="fa-solid fa-pencil-alt"></i>
                    <textarea id="descripcion" name="descripcion" placeholder="Descripción" required v-model="form.descripcion" disabled></textarea>
                  </div>
                  <div class="input-with-icon">
                    <i class="fa-solid fa-user"></i>
                  
                    <select id="idUsuario" name="idUsuario" v-model="form.idUsuario" disabled>
