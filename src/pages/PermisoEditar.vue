            ...
            <div class="form-container">
              <form @submit.prevent="showModal">
                <div class="input-group">
                    ...
                    <input type="text" id="nombreCompleto" name="nombreCompleto" placeholder="Nombre Completo" required v-model="form.nombre">
                ...
                <VueSimpleAlert />
                <button type="submit">ACTUALIZAR EL PERMISO</button>
