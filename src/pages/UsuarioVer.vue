            ...
            <form @submit.prevent="showModal">
              <div class="input-group">
                <div class="input-with-icon">
                  ...
                  <input type="text" id="nombreCompleto" name="nombreCompleto" placeholder="Nombre Completo" required v-model="form.nombreCompleto" readonly>
                </div>
                <div class="input-with-icon">
                  <i class="fa-solid fa-user"></i>
                  <input type="text" id="apellidoCompleto" name="apellidoCompleto" placeholder="Apellido Completo" required v-model="form.apellidoCompleto" readonly>
                </div>
                <div class="input-with-icon">
                  <i class="fa-solid fa-envelope"></i>
                  <input type="email" id="correo" name="correo" placeholder="Correo" required v-model="form.correo" readonly>
                </div>
                <div class="input-with-icon">
                  <i class="fa-solid fa-lock"></i>
                  <input type="password" id="contrasena" name="contrasena" placeholder="Contraseña" required v-model="form.contrasena" readonly>
                </div>
                <div class="input-with-icon">
