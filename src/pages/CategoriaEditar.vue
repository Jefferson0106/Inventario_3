            ...
            <div class="form-container">
              <form @submit.prevent="showModal">
                <div class="input-group">
                    ...
                    <input type="text" id="nombreCompleto" name="nombreCompleto" placeholder="Marca De Su Categoria" required v-model="form.marca">
                ...
                <VueSimpleAlert />
                <button type="submit">ACTUALIZAR LA CATEGORIA</button>
