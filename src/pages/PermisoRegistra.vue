      ...
      <div class="project-bg">
          ...
          <div class="form-container">
            <form @submit.prevent="showModal">
              <div class="input-group">
                ...
                <v-select :options="rolOptions" v-model="selectedRol" label="nombreRol" placeholder="Selecciona un rol"></v-select>
              </div>
              <VueSimpleAlert />
        ...
        <div v-if="isThankYouModalVisible" class="modal">
          <div class="modal-content">
            ...
            <p>Gracias por crear el Permiso, se ha registrado correctamente.</p>
    ...
    methods: {
      ...
      async submitForm() {
        try {
          ...
          const response = await axios.post("https://localhost:7061/api/Permiso/Guardar", this.form);
          ...
          console.error(error);
          this.$alert('Ocurrió un error al guardar el Permiso.');
        } finally {
          this.hideModal();
        }
      },
      mostrarAlerta() {
        this.$alert('¡El Permiso ha sido creado!');
      }
    }
  };
  </script>
